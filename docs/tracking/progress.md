...
| Completed planned sessions | 9 |
| Completed problems | 10 |
| Recorded first-baseline time | 40 minutes across Weeks 1–2; Week 3 pending |
| Recorded total work time | 50 minutes across Weeks 1–2; Week 3 pending |
| Current first-solve ratings | 3 A / 7 B / 0 C |
| Current stage | Week 3 core completed; consolidation reviews due |
...
|---|---|---|
| First 10 independent Easy problems | 10 A-rated first solves | 3 / 10 |
